<div align="center">
  ...
  <a href="mailto:andres.posada0919@gmail.com">
...
### ⚡ Quick Signal
- 💼 **Current Role:** Senior Full Stack Engineer at **RentingCarz Holdings**.
- 🚀 **Building:** Fintech solutions ([Equilibrio](https://github.com/aposadadev)) & AI language tools ([AI English Tutor](https://github.com/aposadadev)).
- 🛠️ **Core Technologies:** TypeScript, Vue 3 / Nuxt 3, React / Next.js, Node.js, PostgreSQL / Supabase, Cloudflare.
...
| :--- | :--- | :--- |
| **💳 Equilibrio** | Personal finance platform featuring visual runway calculators, savings pockets & PWA capabilities. | `Nuxt 3` `Nuxt UI` `Supabase` `Cloudflare` |
| **🤖 AI English Tutor** | Interactive AI language tutor with real-time speech evaluation & Anki spaced repetition. | `Vue 3` `Node.js` `WebM` `AI / LLM` |
| **⚽ Match Predictions** | Real-time sports prediction and ranking platform with live score updates. | `Vue.js` `Firebase RTDB` `REST API` |
